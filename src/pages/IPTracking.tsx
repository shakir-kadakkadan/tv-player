...
export const IPTracking = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-600 p-3 md:p-5">
            <div className="mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
                {/* Header */}
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 md:p-8 text-center relative">
                    ...
                    <div className="absolute top-6 right-6 flex gap-2">
                        <button
                            onClick={loadData}
                            className="px-4 py-2 bg-white/20 text-white border-2 border-white rounded font-semibold hover:bg-white hover:text-purple-600 transition-all"
                        >
                            🔄 Refresh
                        </button>
                        <button
                ...
                <div className="p-4 md:p-10 bg-gray-50">
                    ...
                    {!loading && data.length > 0 && (
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 rounded-xl text-center">
                    ...
                    {loading && (
                        <div className="text-center py-12 text-lg text-purple-600">
                            Loading data...
                        </div>
                    )}
                    ...
                    {!loading && data.length > 0 && (
                        <div className="overflow-x-auto rounded-xl shadow">
                            <table className="w-full border-collapse text-sm text-gray-900">
                                ...
                                <tbody>
                                    {data.map((item, index) => (
                                        <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-50 even:bg-gray-50/50 transition-colors">
                    ...
                    <Link
                        to="/"
                        className="inline-block mt-6 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded font-semibold hover:-translate-y-0.5 hover:shadow-lg transition-all"
                    >
                        ← Back to Home
                    </Link>
                </div>
